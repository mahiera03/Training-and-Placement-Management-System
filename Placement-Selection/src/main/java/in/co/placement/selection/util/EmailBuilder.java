package in.co.placement.selection.util;
...
public class EmailBuilder {
	...
	public static String getForgetPasswordMessage1(HashMap<String, String> map) {
		StringBuilder msg = new StringBuilder();

		msg.append("<HTML><BODY>");
		msg.append("<h1>Welcome to job portal </h1>");
		msg.append("<H4>Login Id" + map.get("login") + " Password: " + map.get("password") + "</H4>");
		msg.append("</BODY></HTML>");
