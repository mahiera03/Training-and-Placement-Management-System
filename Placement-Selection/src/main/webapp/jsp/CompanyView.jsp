<%@page import="in.co.placement.selection.controller.CompanyCtl"%>
...
<div class="container mtb">
		<div class="row">
			<div class="col-lg-8">
				<h1 align="center">***Update Company Info***</h1>
				<div class="hline"></div>
				<p></p>
				<form class="contact-form php-mail-form" role="form"
					action="<%=PSView.COMPANY_CTL %>" method="POST" enctype="multipart/form-data">
					<jsp:useBean id="bean"
								...
								<div class="cols-sm-10">
									<div class="input-group">
										...
										<textarea type="text" class="form-control" name="description" 
											cols="100" rows="3" required><%=DataUtility.getStringData(bean.getDescription()) %></textarea>
									</div>
								</div>
							</div>
						<div class="form-group">
    <label for="exampleFormControlFile1">COMPANY LOGO</label>
    <input type="file" class="form-control-file " name="photo" id="exampleFormControlFile1" disabled="disabled">
    <img src="../jsp/getImage.jsp?id=<%=bean.getId()%>" alt="Avatar" width="200px" height="128" />
  </div>				
					<br>
					<button type="submit" name="operation"
						value="<%=CompanyCtl.OP_SAVE%>"
						class="btn btn-primary mb-2">Update Company</button>
